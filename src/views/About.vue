<template>
  <div class="main container">
    <h1>3-Dimension structure Representation Sharing</h1> 
...
export default {
  ...
  setup() {
    ...
    const aboutPanel = {
      header: " About us",
      description: `<p>3D Representation Sharing has been developed by the <a href="https://mmb.irbbarcelona.org" target="_blank">Molecular Modeling and Bioinformatics</a> laboratory at the <a href="https://irbbarcelona.org" target="_blank">IRB Barcelona</a>.</p>
    ...
    return { welcomePanel, aboutPanel }
  }
}
</script>
